...
#include <graph_slam_uk/slam_optimizer/switchable_constraints/edge_se2MaxMixture.h>
...
bool EdgeSE2MaxMixture::read(std::istream& is)
{
  ...
  nu_nullHypothesis =
      1.0 / sqrt(information_nullHypothesis.inverse().determinant());
...
void EdgeSE2MaxMixture::computeError()
{
  ...
  double mahal_constraint =
      _error.transpose() * information_constraint * _error;
  double likelihood_constraint = nu_constraint * exp(-mahal_constraint);

  double mahal_nullHypothesis =
      _error.transpose() * (information_nullHypothesis)*_error;
  double likelihood_nullHypothesis =
      nu_nullHypothesis * exp(-mahal_nullHypothesis);
...
// ================================================
// #ifdef G2O_HAVE_OPENGL
// EdgeSE2MaxMixtureDrawAction::EdgeSE2MaxMixtureDrawAction()
//   : DrawAction(typeid(EdgeSE2MaxMixture).name())
// {
// }

// g2o::HyperGraphElementAction* EdgeSE2MaxMixtureDrawAction::
