...
// #include <GL/gl.h>
// #endif
#include <graph_slam_uk/slam_optimizer/switchable_constraints/edge_se3Switchable.h>
...
void EdgeSE3Switchable::linearizeOplus()
{
  ...
  g2o::internal::computeEdgeSE3Gradient(E, _jacobianOplus[0], _jacobianOplus[1],
                                        Z, Xi, Xj);
...
// #ifdef G2O_HAVE_OPENGL
// EdgeSE3SwitchableDrawAction::EdgeSE3SwitchableDrawAction()
//   : DrawAction(typeid(EdgeSE3Switchable).name())
// {
// }

// g2o::HyperGraphElementAction* EdgeSE3SwitchableDrawAction::
