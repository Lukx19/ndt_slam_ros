...
void EdgeSE2Switchable::linearizeOplus()
{
  ...
  _jacobianOplus[0](0, 0) = -ci;
  _jacobianOplus[0](0, 1) = -si;
  _jacobianOplus[0](0, 2) = -si * dt.x() + ci * dt.y();
  _jacobianOplus[0](1, 0) = si;
  _jacobianOplus[0](1, 1) = -ci;
  _jacobianOplus[0](1, 2) = -ci * dt.x() - si * dt.y();
  _jacobianOplus[0](2, 0) = 0;
  _jacobianOplus[0](2, 1) = 0;
  _jacobianOplus[0](2, 2) = -1;

  _jacobianOplus[1](0, 0) = ci;
  _jacobianOplus[1](0, 1) = si;
  _jacobianOplus[1](0, 2) = 0;
  _jacobianOplus[1](1, 0) = -si;
  _jacobianOplus[1](1, 1) = ci;
  _jacobianOplus[1](1, 2) = 0;
  _jacobianOplus[1](2, 0) = 0;
  _jacobianOplus[1](2, 1) = 0;
  _jacobianOplus[1](2, 2) = 1;
  ...
  g2o::SE2 delta =
      _inverseMeasurement * (vi->estimate().inverse() * vj->estimate());
...
// #ifdef G2O_HAVE_OPENGL
// EdgeSE2SwitchableDrawAction::EdgeSE2SwitchableDrawAction()
//   : DrawAction(typeid(EdgeSE2Switchable).name())
// {
// }

// g2o::HyperGraphElementAction* EdgeSE2SwitchableDrawAction::
...
//   glBegin(GL_LINES);
//   glVertex3f(fromEdge->estimate().translation().x(),
//              fromEdge->estimate().translation().y(), 0.);
//   glVertex3f(toEdge->estimate().translation().x(),
//              toEdge->estimate().translation().y(), 0.);
//   glEnd();
//   glPopAttrib();
//   return this;
// }
